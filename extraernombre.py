from humedales import LoadData
humedal = LoadData("LenguajesProgramacion/humedales.csv")
import functools
...
print("Nombres de los humedales:\n", extraer_nombres(humedal))
...
print("Total de hectáreas:", total_hectareas(humedal))
...
# print("Promedio de biodiversidad:", promedio_biodiversidad(humedal))



print(filtrar_por_estado(humedal, "Regular"))



#TraeR HECHO CON EL EVALUADOR PERESOZO
#EAGER EVALUATION Y LAZY
